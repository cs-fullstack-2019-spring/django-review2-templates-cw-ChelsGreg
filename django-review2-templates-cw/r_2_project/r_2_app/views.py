...
# FUNCTION TO DISPLAY SONG LIST ON SONG LIST PAGE/LINK TO HTML PAGE
...
# FUNCTION TO DISPLAY SPECIFIC OBJECTS ON FIRST DETAILS PAGE/LINK TO HTML PAGE
def list_song(request, song_id):

    return render(request, 'r_2_app/song_details.html', {'current_song': songs[song_id]})


# FUNCTION TO DISPLAY SPECIFIC OBJECTS ON SECOND DETAILS PAGE/LINK TO HTML PAGE
def lastdetails(request, song_id):

    return render(request, 'r_2_app/lastdetails.html', {'listen_here': songs[song_id]})